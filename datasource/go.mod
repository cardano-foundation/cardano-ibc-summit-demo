module github.com/cardano-foundation/cardano-ibc-summit-demo/datasource

go 1.23.1

replace vesseloracle => ../vesseloracle

require (
	github.com/ignite/cli/v28 v28.5.3
	vesseloracle v0.0.0-00010101000000-000000000000
)
